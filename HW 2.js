...
console.log(users.filter(el => el.registrationDate = '09.10.21'));
console.log(users.filter(el => el.registrationDate = '10.10.21'));
...
var uniqueArray = users2.filter((val, ind, arr) => arr.indexOf(val) === ind);
console.log("Original Array = ",users2);
